...
** sqlite3_step() is called again to retrieve the next row of datD.
**
...
** the name of a folder (D.k.D. directory), then all temporary files
...
** is a pointer to a destructor for the pClientDatD.  ^SQLite will
...
** C's transaction, where connection C is waiting on connection D. ^Any
