...
@property (nonatomic, strong) NSDictionary* dictionaryCodeDisplayCategory;
...
#else
@property (nonatomic, retain) iHungry_MeAppDelegate *theAppDelegate;
#endif
...
- (id) initForVersionOnly:(BOOL)fetchVersionOnly  catArray:(NSArray*)catArray minimumRecipeId:(int)minId context:(NSManagedObjectContext*)context;
// - (void) setupMacXmlRun2; // not used
